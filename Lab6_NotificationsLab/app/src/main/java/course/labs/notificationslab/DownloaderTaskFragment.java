...
public class DownloaderTaskFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG, "Download of tweets has been executed");
    ...
    public class DownloaderTask extends AsyncTask<ArrayList<Integer>, Void, String[]> {
        ...
        protected String[] doInBackground(ArrayList<Integer>... arrayLists) {
            ArrayList<Integer> data =  arrayLists[0]; // 0 = TAG_FRIEND_RES_IDS, 1 = sRawTextFeedIds);
        ...
        protected void onPostExecute(String[] strings) {
            Log.i(TAG, "Notification of refresh was called");
            if (mCallback != null)
