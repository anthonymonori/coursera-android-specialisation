...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView priority = (TextView) view.findViewById(R.id.priorityView);
        priority.setText(toDoItem.getPriority().toString());

		// TODO - Display Time and Date
        TextView timeAndDate = (TextView)view.findViewById(R.id.dateView);
        timeAndDate.setText(ToDoItem.FORMAT.format(toDoItem.getDate()));
